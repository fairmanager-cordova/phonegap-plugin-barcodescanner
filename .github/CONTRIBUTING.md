...
```
git clone git@github.com:your-username/plugin-barcodescanner.git
```
...
git remote add upstream https://github.com/fairmanager-cordova/plugin-barcodescanner.git
```
