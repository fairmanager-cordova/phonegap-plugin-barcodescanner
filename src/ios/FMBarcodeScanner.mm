...
//------------------------------------------------------------------------------
@protocol FMBarcodeScannerOrientationDelegate <NSObject>
...
//------------------------------------------------------------------------------
@class FMBarcodeScannerProcessor;
@class FMBarcodeScannerViewController;

//------------------------------------------------------------------------------
// plugin class
//------------------------------------------------------------------------------
@interface FMBarcodeScanner : CDVPlugin {}
...
//------------------------------------------------------------------------------
@interface FMBarcodeScannerProcessor : NSObject <AVCaptureMetadataOutputObjectsDelegate> {}
@property (nonatomic, retain) FMBarcodeScanner*               plugin;
@property (nonatomic, retain) NSString*                       callback;
@property (nonatomic, retain) UIViewController*               parentViewController;
@property (nonatomic, retain) FMBarcodeScannerViewController* viewController;
...
- (id)initWithPlugin:(FMBarcodeScanner*)plugin callback:(NSString*)callback parentViewController:(UIViewController*)parentViewController alterateOverlayXib:(NSString *)alternateXib;
- (void)scanBarcode;
...
//------------------------------------------------------------------------------
@interface FMQrProcessor: NSObject
@property (nonatomic, retain) FMBarcodeScanner*          plugin;
@property (nonatomic, retain) NSString*                  callback;
@property (nonatomic, retain) NSString*                  stringToEncode;
@property                     NSInteger                  size;

- (id)initWithPlugin:(FMBarcodeScanner*)plugin callback:(NSString*)callback stringToEncode:(NSString*)stringToEncode;
- (void)generateImage;
@end
...
//------------------------------------------------------------------------------
@interface FMBarcodeScannerViewController : UIViewController <FMBarcodeScannerOrientationDelegate> {}
@property (nonatomic, retain) FMBarcodeScannerProcessor* processor;
@property (nonatomic, retain) NSString*                  alternateXib;
...
- (id)initWithProcessor:(FMBarcodeScannerProcessor*)processor alternateOverlay:(NSString *)alternateXib;
- (void)startCapturing;
...
// plugin class
//------------------------------------------------------------------------------
@implementation FMBarcodeScanner
...
//--------------------------------------------------------------------------
- (void)scan:(CDVInvokedUrlCommand*)command {
	FMBarcodeScannerProcessor* processor;
	NSString*       callback;
	...
	processor = [[FMBarcodeScannerProcessor alloc]
				initWithPlugin:self
				callback:callback
...
- (void)encode:(CDVInvokedUrlCommand*)command {
	...
	FMQrProcessor* processor;
	NSString*      callback;
	callback = command.callbackId;

	processor = [[FMQrProcessor alloc]
					initWithPlugin:self
					callback:callback
...
// class that does the grunt work
//------------------------------------------------------------------------------
@implementation FMBarcodeScannerProcessor
...
//--------------------------------------------------------------------------
- (id)initWithPlugin:(FMBarcodeScanner*)plugin
...
parentViewController:(UIViewController*)parentViewController
  alterateOverlayXib:(NSString *)alternateXib {
	...
	CFURLRef soundFileURLRef  = CFBundleCopyResourceURL(CFBundleGetMainBundle(), CFSTR("FMBarcodeScanner.bundle/beep"), CFSTR ("caf"), NULL);
...
- (void)scanBarcode {
	...
	self.viewController = [[FMBarcodeScannerViewController alloc] initWithProcessor: self alternateOverlay:self.alternateXib];
...
#if USE_SHUTTER
	if (!self.viewController.shutterPressed) {
		return;
	}
...
- (void)generateImage{
	...
	[filter setValue:[self.stringToEncode dataUsingEncoding:NSUTF8StringEncoding] forKey:@"inputMessage"];
	...
	UIImage *qrImage = [UIImage imageWithCGImage:cgImage scale:1. orientation:UIImageOrientationUp];
...
// view controller for the ui
//------------------------------------------------------------------------------
@implementation FMBarcodeScannerViewController
...
- (UIView*)buildOverlayView {
	...
	if (_processor.isShowTorchButton && !_processor.isFrontCamera) {
		...
		if ([device hasTorch] && [device hasFlash]) {
			NSURL* bundleURL = [[NSBundle mainBundle] URLForResource:@"FMBarcodeScanner" withExtension:@"bundle"];
...
#pragma mark FMBarcodeScannerOrientationDelegate
